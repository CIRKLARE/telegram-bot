...
#------------------------------------------------------------------  
# echo your name example : /test john
def test(update: Update, context: CallbackContext):
    #print('%s' % update.message.text)
    username = '%s' % update.message.text
    print(username[6:])
    update.message.reply_text("welcome %s " % update.message.text[5:])
#------------------------------------------------------------------ 

def unknown(update: Update, context: CallbackContext):
    update.message.reply_text(
        "Sorry '%' is not a valid command"  % update.message.text)
